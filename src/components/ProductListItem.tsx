  ...
  return (
    <div className="w-full border-b border-neutral-200 py-4 flex gap-4">
      ...
      <div className="flex-1 min-w-0">
        <Link to={`/products/${product.id}`} className="block">
          <h3 className="text-base sm:text-lg font-medium text-neutral-900 hover:underline truncate">
            {product.name}
          </h3>
        </Link>
        {product.description && (
      ...
      <div className="w-28 sm:w-40 flex-shrink-0 text-right">
        <div className="text-lg sm:text-xl font-semibold text-neutral-900">₹{price}</div>
