          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              {/* <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="hover:underline text-violet-600 transition-colors">Reset password</a>
              </div> */}
            ...
            <button onClick={onGoogleSignIn} className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-gray-300 rounded-2xl py-4 hover:bg-gray-50 transition-colors text-gray-700">
                <GoogleIcon />
                Continue with Google
            </button>

            <p className="animate-element animate-delay-900 text-center text-sm text-gray-600">
              New to our platform? <a href="#" onClick={(e) => { e.preventDefault(); onCreateAccount?.(); }} className="text-violet-600 hover:underline transition-colors">Create Account</a>
            </p>
          </div>
        </div>
      </section>
        ...
        <section className="hidden md:block flex-1 relative p-4">
          ...
          {features.length > 0 && (
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-4 px-8 w-full justify-center">
              <FeatureCard feature={features[0]} delay="animate-delay-1000" />
              {features[1] && <div className="hidden xl:flex"><FeatureCard feature={features[1]} delay="animate-delay-1200" /></div>}
              {features[2] && <div className="hidden 2xl:flex"><FeatureCard feature={features[2]} delay="animate-delay-1400" /></div>}
            </div>
          )}
        </section>
      )}
